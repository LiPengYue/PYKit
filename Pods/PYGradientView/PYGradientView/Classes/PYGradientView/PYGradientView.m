...
//
#import "PYGradientView.h"

@interface PYGradientView()

@property (nonatomic,strong) PYGradientViewDrawRadialConfig *drawRadialConfig;
@property (nonatomic,strong) PYGradientViewLineConfig *drawLineConfig;
@property (nonatomic,assign) BOOL isFirstLayout;
@property (nonatomic,assign) BOOL isDrawLine;
@end


@implementation PYGradientView
...
- (PYGradientViewDrawRadialConfig *)drawRadialConfig {
    if (!_drawRadialConfig) {
        _drawRadialConfig = [PYGradientViewDrawRadialConfig new];
    }
    return _drawRadialConfig;
}
- (PYGradientViewLineConfig *)drawLineConfig {
    if (!_drawLineConfig) {
        _drawLineConfig = [PYGradientViewLineConfig new];
    }
